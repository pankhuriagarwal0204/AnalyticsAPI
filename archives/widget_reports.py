...
from django.db.models import ExpressionWrapper, DurationField, TimeField, DateTimeField, Sum, Count
from django.db.models import F
from django.db.models import Func

from models import Morcha, Post, Battalion
from models import Weaksignal, Backup, Offline
...
class Widgets:
    ...
    def get_unit_report_post(self):
        ...
        all_morchas_stats = ({i.name:{'weak_signal':weak_signal_cache.get(i.pk,0),'backup':backup_cache.get(i.pk,0),
                                     'offline':offline_cache.get(i.pk,0)}}for i in all_morchas)
